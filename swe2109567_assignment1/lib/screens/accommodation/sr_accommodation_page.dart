...
class SRAccommodationPage extends StatefulWidget {
  const SRAccommodationPage({super.key});

  @override
  State<SRAccommodationPage> createState() => _SRAccommodationPageState();
}

class _SRAccommodationPageState extends State<SRAccommodationPage> {
  ...
  void _getInitialInfo() {
    accommodation = Accommodation.getAccommodationsByRating();
  }
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                            'RM${accommodation[index]
                                .price} | ${accommodation[index]
                                .category} | ${accommodation[index]
                                .distance}km',
                            style: const TextStyle(
                                color: Colors.black,
                                fontSize: 14,
