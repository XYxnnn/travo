...
class SAttractionPage extends StatefulWidget {
  const SAttractionPage({super.key});

  @override
  State<SAttractionPage> createState() => _SAttractionPageState();
}

class _SAttractionPageState extends State<SAttractionPage>{

  List<Attractions> attractions = [];
  List<String> dropDown = <String>["Distance"];

  void _getInitialInfo() {
    attractions = Attractions.getAttractionsByDistance();
  }
